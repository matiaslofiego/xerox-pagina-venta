    ...
    switch (opcion) {
        ...
        case "Mangas":
            ...
            switch (opcionManga) {
                ...
                case "Death note":
                case "Death Note":
                    console.log("Gracias por comprar Death Note #10");
                    break
                case "2":
                case "bleach":
                case "Bleach":
                case "BLEACH":
                case "bleach remix":
                    console.log("Gracias por comprar BLEACH Remix #1");
                    break
                case "3":
                case "one piece":
                case "one":
                case "One piece":
                case "One Piece":
                    console.log("Gracias por comprar One Piece #1");
                    break
                case "4":
                case "chainsaw":
                case "chainsawman":
                case "chainsaw-man":
                case "Chainsawman":
                    console.log("Gracias por comprar Chainsaw-Man #1");
                    break
                case "5":
                case "vinland":
                case "vinland saga":
                case "Vinland Saga":
                    console.log("Gracias por comprar Vinland Saga #1");
                    break;
                case"0":
                    console.log("Compra cancelada");
                    break
        ...
        case "Videojuegos":
            ...
            switch (opcionVideojuegos) {
                ...
                case "Elden ring":
                case "Elden Ring":
                    console.log("Gracias por comprar Elden Ring PS5");
                    break
                case "2":
                case "god of war":
                case "god":
                ...
                case "God of war":
                case "God of war ragnarok":
                    console.log("Gracias por comprar God of War Ragnarok PS5");
                    break
                case "3":
                case "horizon":
                case "Horizon":
                case "horizon forbidden west":
                    console.log("Gracias por comprar Horizon Forbidden West PS4");
                    break
                case "4":
                case "the last of us":
                case "The last of us":
                case "The last of us parte 1":
                    console.log("Gracias por comprar The Last of Us Parte 1 PS5");
                    break
                case "5":
                case "fifa":
                case "Fifa":
                case "FIFA":
                case "fifa 23":
                    console.log("Gracias por comprar FIFA 23 PS4");
                    break;
                case"0":
                    console.log("Compra cancelada");
                    break
        ...
        case"juego de cartas":
            ...
            switch (opcionCartas) {
                ...
                case "Magic":
                case "Magic the gathering":
                    console.log("Gracias por comprar Magic The Gathering");
                    break
                case "2":
                case "yugioh":
                case "Yugioh":
                case "YUGIOH":
                    console.log("Gracias por comprar YUGIOH Eternity Code");
                    break
                case "3":
                case "pokemon":
                case "Pokemon":
                ...
                case "Pokemon card game":
                    console.log("Gracias por comprar Pokemon Card Game");
                    break
                case"0":
                    console.log("Compra cancelada");
                    break
